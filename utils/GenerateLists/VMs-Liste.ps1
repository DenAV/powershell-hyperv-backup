<#
.SYNOPSIS
    The script creates a list of VMs and divides it into the specified number of parts
.DESCRIPTION
    
.NOTES
    File Name      : VMs-Liste.ps1
.LINK
    https://www.powershellgallery.com/packages/VMs-Liste
.EXAMPLE
    PS C:\> .\VMs-Liste.ps1
#>
...
$vms_path = 'C:\Scripts\HyperV-Backup\Liste'
